<?php /* Smarty version 2.6.31, created on 2020-12-16 03:21:51
         compiled from default/views/day/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day/ajax_template.html', 10, false),array('function', 'xla', 'default/views/day/ajax_template.html', 181, false),array('function', 'xlt', 'default/views/day/ajax_template.html', 181, false),array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 388, false),array('modifier', 'date_format', 'default/views/day/ajax_template.html', 383, false),array('modifier', 'string_format', 'default/views/day/ajax_template.html', 384, false),)), $this); ?>
...
' onClick='GoToToday(theform);'  class='css_button'/><span><?php echo smarty_function_xlt(array('t' => 'Today'), $this);?>
</span></a>
<?php 
}
...
echo "<td class='timeslot providerXbtn' data-username='__PC_ALL__'><i class='fa fa-lg fa-user-md'></i></td>";
//============================================================================================================================
            ...
            if ($catid == 2 || $catid == 3 || $catid == 4 || $catid == 8 || $catid == 11) {
                ...
                if ($patientid) {
                    ...
                    $content .= "<img src='{$this->_tpl_vars['TPL_IMAGE_PATH']}/user-green.gif'
                                      onmouseover=\"javascript:ShowImage(" . attr_js($GLOBALS['webroot']."/controller.php?document&retrieve&patient_id=".attr($patientid)."&document_id=-1&as_file=false&original_file=true&disable_exit=false&show_original=true&context=patient_picture") . ");\"
                                      onmouseout=\"javascript:HideImage();\"
                                      border='0' title='" . attr($link_title) . "' alt='" . xla('View Patient') . "' />";
          ...
          echo "<div class='" . attr($evtClass) . " event' style='top:".$evtTop."; height:".$evtHeight.
           ...
           if ($event['catid'] == 2) {
               ...
               echo "<div class='" . attr($evtClass) ." event in_start' style='top:".$inTop.
                   ...
                   " id='" . attr($eventdate) . "-" . attr($eventid) . "-" . attr($pccattype) . "'".
                   ">";
               $content = "<span style='color:red;text-align:center;font-weight:bold'>" . text($row['name']) . "</span>";
               echo $content;
               echo "</div>\n";
           }
           ...
           echo "<div class='" . attr($evtClass) . " event' style='top:".$evtTop."; height:".$evtHeight.
               ...
               ">";
           // second part for the special IN event
           if ($event['catid'] != 2) { echo "<span style='color:red;text-align:center;font-weight:bold'>" . text($row['name']) . "</span>"; }
           echo "</div>\n";
       }
  } // end EVENT loop
