...
<html>
    ...
    <body class="body_top">
        ...
        <!-- Search can be done using range, gender, and ethnicity filters.
        ...
        if ($_POST['form_refresh']) {
            ...
            switch ($srch_option) {
                ...
                case "Communication":
                    ...
                    $sort = array("patient_date","patient_name","patient_id","patient_sex","users_provider", "communications");
                    if ($sortby == "") {
                        $sortby = $sort[6];
                    }
                    ...
                    break;
                case "Demographics":
                    $sort = array("patient_date","patient_name","patient_id","patient_sex","patient_race","patient_ethinic","users_provider");
                    break;
            }
                ...
                <div id = "report_results">
                    ...
                    if ($srch_option == "Medications" || $srch_option == "Allergies" || $srch_option == "Problems") { ?>
                        <tr style="font-size:15px;">
                            ...
                            <td width="10%"><b><?php echo xlt('PID');?></b></td>
                        ...
                        <tr style="font-size:15px;">
                            ...
                            <td width="10%"><b><?php echo xlt('PID');?></b><?php echo $sortlink[2]; ?></td>
                        ...
                        <tr style="font-size:15px;">
                            <td width="15%"><b><?php echo xlt('Date'); ?></b><?php echo $sortlink[0]; ?></td>
                            <td width="20%"><b><?php echo xlt('Patient Name'); ?></b><?php echo $sortlink[1]; ?></td>
                            <td width="20%"><b><?php echo xlt('PID');?></b><?php echo $sortlink[2]; ?></td>
                            <td width="10%"><b><?php echo xlt('Gender'); ?></b><?php echo $sortlink[4]; ?></td>
